<%@ Page Title="EditSiteEngineerDistrictPage" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditSiteEngineerDistrictPage.aspx.cs" Inherits="ENETCare.IMS.WebApp.EditSiteEngineerDistrictPageUI" %>


<asp:Content ID="InterventionsContent" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Edit Site Engineer</h1>
    <asp:Label ID ="Site_Engineer_Name" runat="server"></asp:Label>
    <p>---oOo---</p>
